...
export default function CaseStudyFinanza() {
  return (
    <section className="relative">
      ...
      <div className="bg-[#F4F4F4] lg:h-[940px] relative z-50">
        <Navbar />
        ...
        <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto  pt-24 md:pt-32 lg:pt-40">
          <div className="space-y-4 md:space-y-8">
            <h4 className="text-2xl md:text-4xl lg:text-5xl font-switzer font-medium text-center">
              Budget App - empowering financial management
            </h4>
            <p className="text-center  md:text-xl lg:text-2xl font-switzer max-w-[1120px] m-auto">
              This case study explores how Budget App provides users with a
              seamless and intuitive platform to create and manage budgets,
              empowering them to achieve their financial goals.
            </p>

            <img
              src="images/case-study-budget/banner.webp"
              alt=""
              className="w-[800px] m-auto object-contain"
            />
          </div>
        </div>
      </div>
      ...
      <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto  py-10 lg:py-20 bg-white relative z-50">
        <div className="space-y-4">
          <h4 className="md:text-2xl font-switzer text-center">
            Introducing the
            <span className="text-[#437FF9] font-switzer"> Budget App</span>
          </h4>
          <p className="text-2xl md:text-4xl lg:text-5xl font-switzer font-medium text-center max-w-[1120px] m-auto">
            Empowering financial management with{" "}
            <span className="text-[#A463F9]">Budget App</span>
          </p>
        </div>
      </div>
