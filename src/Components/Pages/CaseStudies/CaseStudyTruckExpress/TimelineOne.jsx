    ...
    <div className="relative">
      ...
      <div className="lg:grid grid-cols-2 gap-20 space-y-10 lg:space-y-0 lg:pl-0">
        ...
        <div className="" data-aos="zoom-in" data-aos-duration="1000">
          <img
            src="/images/case-study-truckexpress/timeline-img-one.webp"
            alt="timeline"
        ...
        <div className="" data-aos="zoom-in" data-aos-duration="1000">
          <img
            src="/images/case-study-truckexpress/timeline-img-two.webp"
            alt="timeline"
        ...
        <div className="" data-aos="zoom-in" data-aos-duration="1000">
          <img
            src="/images/case-study-truckexpress/timeline-img-three.webp"
            alt="timeline"
            className="w-[500px] m-auto object-contain"
          />
        </div>
