...
export default function SwiperCards(props) {
  return (
    <div className="px-4 md:px-8 pt-8 pb-12 bg-white space-y-6 relative">
      <h4 className="text-[#004AEA] text-2xl font-switzer font-medium">
