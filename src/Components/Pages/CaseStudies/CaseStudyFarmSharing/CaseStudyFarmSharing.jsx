...
export default function CaseStudyFarmSharing() {
  return (
    <section className="relative">
      ...
      <div className="bg-[#FCFFEA] relative z-50 lg:h-[940px]">
        <Navbar />
        ...
        <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto pt-24 md:pt-32 lg:pt-40">
          <div className="space-y-4 md:space-y-8">
            <h4 className="text-2xl md:text-4xl lg:text-5xl font-switzer font-medium text-center">
              Farm Sharing - revolutionizing farming and agriculture
            </h4>
            <p className="text-center  md:text-xl lg:text-2xl font-switzer max-w-[1120px] m-auto">
              This case study explores how Farm Sharing provides a seamless and
              convenient platform for users to purchase farming materials, hire
              agricultural products, and access skilled labor for their farming
              needs.
            </p>
          </div>
        </div>

        <div className="relative before:content-[''] before:absolute before:bg-farmBannerBg before:bg-cover before:bg-no-repeat before:top-0 before:right-0 before:w-full before:h-full">
          <img
            src="images/case-study-farmsharing/banner.webp"
            alt=""
            className="w-[940px] m-auto object-contain relative z-30"
          />
        </div>
      </div>
      ...
      <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto  py-10 lg:py-20 bg-white relative z-40">
        <div className="space-y-4">
          <h4 className="md:text-2xl font-switzer text-center">
            Introducing the
            <span className="text-[#259753] font-switzer"> Farm Sharing</span>
          </h4>
          <p className="text-2xl md:text-4xl lg:text-5xl font-switzer font-medium text-center max-w-[1120px] m-auto">
            Revolutionizing farming and agriculture with
