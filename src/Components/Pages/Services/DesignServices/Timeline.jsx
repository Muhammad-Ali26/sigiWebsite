    ...
    <div className=" lg:pt-20">
      <div className="w-full h-[2px] bg-[#FFFFFF33]  hidden lg:block">
        <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto relative">
          <div className="w-6 h-6 bg-sigiYellow rounded-full outline outline-[#FFFFFF33] absolute -top-3"></div>
          <div className="w-6 h-6 bg-sigiYellow rounded-full outline outline-[#FFFFFF33] absolute -top-3 left-[26%]"></div>
          <div className="w-6 h-6 bg-sigiYellow rounded-full outline outline-[#FFFFFF33] absolute -top-3 left-[53%]"></div>
      ...
      <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto space-y-7 md:space-y-16">
        <div className="md:grid md:grid-cols-2 lg:grid-cols-4 gap-20 pt-10 space-y-6 md:space-y-0">
          <div className="space-y-6">
            <h4 className="text-2xl md:text-3xl text-white font-switzer font-medium">
              Discovery - Let's Chat and Unveil the Secrets
            </h4>
          ...
          <div className="space-y-6">
            <h4 className="text-2xl md:text-3xl text-white font-switzer font-medium">
              Exploration - Mapping the Route to Design Greatness
            </h4>
            <p className="text-white font-switzer">
          ...
          <div className="space-y-6">
            <h4 className="text-2xl md:text-3xl text-white font-switzer font-medium">
              Creation - Unleash the Creative Chaos!
            </h4>
            <p className="text-white font-switzer">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white font-switzer">
              Our commitment doesn't stop at launch. We believe in continuous
              improvement. We'll optimize, refine, and tweak to squeeze every
              bit of performance out of our design masterpiece. Sit back and
