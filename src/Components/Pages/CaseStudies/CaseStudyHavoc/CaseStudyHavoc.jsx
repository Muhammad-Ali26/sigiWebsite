...
export default function CaseStudyHavoc() {
  return (
    <section className="relative">
      ...
      <div className="bg-[#F1EFFA] relative z-50 lg:h-[980px]">
        <Navbar />
        ...
        <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto pt-24 md:pt-32 lg:pt-40">
          <div className="space-y-4 md:space-y-8">
            <h4 className="text-2xl md:text-4xl lg:text-5xl font-switzer font-medium text-center">
              Havoc Entertainment - revolutionizing the DJ service industry
            </h4>
            <p className="text-center  md:text-xl lg:text-2xl font-switzer max-w-[1120px] m-auto">
              This case study explores how Havoc Entertainment provides a
              seamless and convenient platform for users to discover, explore,
              and hire DJ services for various events and occasions.
            </p>

            <img
              src="images/case-study-havoc/banner.webp"
              alt=""
              className="w-[970px] m-auto object-contain"
            />
          </div>
        </div>
      </div>
      ...
      <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto  py-10 lg:py-20 bg-white relative z-40">
        <div className="space-y-4">
          <h4 className="md:text-2xl font-switzer text-center">
            Introducing the
            <span className="text-[#DA212799] font-switzer">
              {" "}
              Havoc Entertainment{" "}
            </span>
          </h4>
          <p className="text-2xl md:text-4xl lg:text-5xl font-switzer font-medium text-center max-w-[1120px] m-auto">
            Revolutionizing the DJ service industry with
            <span className="text-[#3CA9EE]">
              <br /> Havoc Entertainment
            </span>
          </p>
        </div>
      </div>
