...
export default function CaseStudyKiwikMart() {
  return (
    <section className="relative">
      ...
      <div className="bg-[#E2F9F7] relative z-50 lg:h-[960px]">
        <Navbar />
        ...
        <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto pt-24 md:pt-32 lg:pt-40">
          <div className="space-y-4 md:space-y-8">
            <h4 className="text-2xl md:text-4xl lg:text-5xl font-switzer font-medium text-center">
              Kwik e Mart - revolutionizing online grocery shopping
            </h4>
            <p className="text-center  md:text-xl lg:text-2xl font-switzer max-w-[1120px] m-auto">
              This case study explores how Kwik e Mart provides a seamless and
              convenient platform for users to purchase a wide range of
              groceries, making their shopping experience efficient and
              hassle-free.
            </p>

            <img
              src="images/case-study-kiwimart/banner.webp"
              alt=""
