...
export default function CaseStudyPacifrica() {
  return (
    <section className="relative">
      ...
      <div className="bg-[#CEEAFC] relative z-50 lg:h-[940px]">
        <Navbar />
        ...
        <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto pt-24 md:pt-32 lg:pt-40">
          <div className="space-y-4 md:space-y-8">
            ...
            <p className="text-center  md:text-xl lg:text-2xl font-switzer max-w-[1120px] m-auto">
              ...
              Logistic, a leading courier delivery company in Panama, and how we
              revolutionized their address allocation system using our
              cutting-edge DBS Code System.
            </p>
          </div>
        </div>

        <div className="relative before:content-[''] before:absolute before:bg-pacifricaBannerBg before:bg-cover before:bg-no-repeat before:top-0 before:right-0 before:w-full before:h-full">
          <img
            src="images/case-study-pacifrica/banner.webp"
            alt=""
            className="w-[920px] m-auto object-contain relative z-30"
          />
        </div>
      </div>
      ...
      <div className="w-[90%] lg:w-[80%] 2xl:w-[68%] m-auto  py-10 lg:py-20 bg-white relative z-40">
        <div className="space-y-4">
          <h4 className="md:text-2xl font-switzer text-center">
            Introducing the
            <span className="text-[#202053] font-switzer"> Pacifrica</span>
          </h4>
          <p className="text-2xl md:text-4xl lg:text-5xl font-switzer font-medium text-center max-w-[1120px] m-auto">
            Revolutionizing Courier Delivery in Panama with
            <span className="text-sigiYellow"> DBS Code System</span>
          </p>
        </div>
      </div>
